...
def upgrade() -> None:
    ...
    op.execute(sa.text("CREATE TYPE IF NOT EXISTS questtypeenum AS ENUM ('daily_login', 'feed_pet', 'earn_xp')"))
    op.execute(sa.text("CREATE TYPE IF NOT EXISTS queststatusenum AS ENUM ('available', 'active', 'completed', 'expired')"))
