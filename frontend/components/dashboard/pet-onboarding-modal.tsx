...
export function PetOnboardingModal({
  ...
  const [step, setStep] = useState<"welcome" | "create" | "customize">(
    "welcome"
  );
  ...
  const selectedSpeciesData =
    availableSpecies.find((s) => s.id === selectedSpecies) ||
    availableSpecies[0];
          ...
          <>
            <DialogHeader className="text-center">
              ...
              <DialogDescription className="text-center text-base leading-relaxed">
                Your learning journey just got more exciting! Get ready to adopt
                your very own virtual learning companion.
              </DialogDescription>
            </DialogHeader>
        ...
        {step === "create" && (
          <>
            ...
            <div className="flex justify-between">
              ...
              <Button onClick={handleNext}>Next: Name Your Pet</Button>
            </div>
          </>
        )}
          ...
          <>
            ...
            <div className="space-y-6 py-4">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Your {selectedSpeciesData.name} is ready to start this journey
                  with you!
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onKeyDown={(e) =>
                    e.key === "Enter" && petName.trim() && handleCreatePet()
                  }
                  maxLength={50}
                />
                <p className="text-xs text-muted-foreground">
                  Choose a name that inspires you to learn! You can change it
                  later.
                </p>
              </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">
                        Your pet will be happiest when you're actively learning.
                        Complete quests to keep them healthy and happy!
                      </p>
                    </div>
                  </div>
                </CardContent>
